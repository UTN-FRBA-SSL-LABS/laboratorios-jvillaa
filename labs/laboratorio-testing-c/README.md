...
> R:`carrito_init` inicializa c->cantidad en 0 y es necesario llamarla antes de usar el carrito ya que sino c->cantidad puede arrancar con cualquier valor
...
> R:falla ya que esperaba 700 y obtuvo 350
...
> R:linea 24, suma el precio de cada producto pero ignora la cantidad de cada producto

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R:deberia multiplicar el precio poor la cantidad de ese producto antes de sumarlo
...
> R:<= es el operador incorrecto deberia ser solo <
...
> R:Si la lineas 29 y 30, a la parte de carrito_descuento
...
> R:Unitario prueba funcion aislada, integracion varias juntas 
...
> R:los test te muestran el bug por resultados 
...
> R:con cantidad 1 no hay q multiplciar los productos por la cantidad
